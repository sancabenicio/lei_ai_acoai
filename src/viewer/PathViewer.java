...
/**
 * Classe que mostra um caminho em uma GUI
 */
public class PathViewer {
    ...
    /**
     * Desenha um caminho no mapa. Um caminho é uma {@link List} de {@link IPoint}
     * @param path a lista de pontos a serem desenhados no mapa
     */
    ...
    /**
     * Atualiza o valor de fitness a ser mostrado no mapa.
     * @param fitness o valor de fitness a ser mostrado no mapa
     */
    ...
    /**
     * Atualiza a string que descreve o caminho sendo desenhado no mapa
     * @param stringPath a string que descreve o caminho sendo desenhado
     */
    ...
    private class UI extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            g.drawString("Geração " + iteration + " Melhor Solução: " + stringPath + " (" + fitness + ")", 20, 20);
        }
